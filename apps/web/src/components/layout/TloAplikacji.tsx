  ...
  return (
    <div className="absolute inset-0" aria-hidden="true">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 18% 12%, rgba(124,58,237,0.28), transparent 52%), radial-gradient(circle at 82% 78%, rgba(34,211,238,0.22), transparent 58%), radial-gradient(circle at 55% 45%, rgba(244,114,182,0.12), transparent 62%)",
        }}
      />
      {/* gradienty — dark */}
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 22% 14%, rgba(124,58,237,0.34), transparent 54%), radial-gradient(circle at 78% 84%, rgba(34,211,238,0.26), transparent 60%), radial-gradient(circle at 55% 48%, rgba(244,114,182,0.16), transparent 62%)",
        }}
      />

      {/* aurora blobs */}
      <div
        className="aurora-blob absolute w-190 h-190 top-[-14%] left-[-14%] bg-[#7C3AED] opacity-30! dark:opacity-24! animate-float motion-reduce:animate-none will-change-transform rounded-full"
        style={{ animationDuration: "18s" }}
      />

      <div
        className="aurora-blob absolute w-170 h-170 bottom-[-18%] right-[-14%] bg-[#22D3EE] opacity-26! dark:opacity-20! animate-float motion-reduce:animate-none will-change-transform rounded-full"
        style={{ animationDuration: "22s", animationDelay: "1.2s" }}
      />

      <div
        className="aurora-blob absolute w-140 h-140 top-[42%] left-[14%] bg-[#F472B6] opacity-18! dark:opacity-14! animate-float motion-reduce:animate-none will-change-transform rounded-full"
...
const WarstwaNeural = memo(function WarstwaNeural({ theme }: { theme: TrybMotywu }) {
  ...
  useEffect(() => {
    ...
    koloryRef.current = {
      dot: isDark ? "rgba(124, 58, 237, 0.56)" : "rgba(124, 58, 237, 0.34)",
      connect: isDark ? "rgba(34, 211, 238, 0.24)" : "rgba(34, 211, 238, 0.18)",
    };
